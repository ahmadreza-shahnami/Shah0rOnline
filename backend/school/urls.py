...
from .views import SchoolViewSet, MembershipViewSet, NewsViewSet, ClassroomViewSet,\
...
schools_router.register(r'memberships', MembershipViewSet, basename='school-memberships')
